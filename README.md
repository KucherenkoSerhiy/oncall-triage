...
| M6 | Kubernetes estate on kind: Helm chart, Prometheus/Alertmanager, route B, `estate-demo.yml` | 🔨 merged ([#21](https://github.com/KucherenkoSerhiy/oncall-triage/issues/21), [#22](https://github.com/KucherenkoSerhiy/oncall-triage/issues/22)); route B proven up to the spine, demo run being stabilised ([#68](https://github.com/KucherenkoSerhiy/oncall-triage/issues/68)-[#71](https://github.com/KucherenkoSerhiy/oncall-triage/issues/71)) |
