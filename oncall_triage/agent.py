...
reporter = Agent(
    ...
    instruction=(
        ...
        "FORMAT A - known issue: exactly ONE line, nothing else: "
        "'Known issue: <pattern> - <explanation>.' No alarm, no "
        "recommendation to page.\n\n"
        "FORMAT B - new issue: exactly five lines, each starting with its "
        "label in bold, spelled exactly like this, one per line, in this "
        "order:\n"
        "**Error text:** the error as reported\n"
        "**Cause:** the researcher's likely cause category\n"
        "**Severity:** the researcher's severity guess and its reason\n"
        "**Next step:** the researcher's suggested diagnostic step\n"
        "**Recommendation:** page oncall now, or monitor - and why, in one "
        "sentence\n\n"
        ...
        "Start your reply with the first character of the format. Never "
        "describe who you are, what you received, or what you are about to "
        "do; no headings, no horizontal rules, no closing remarks. The "
        "engineer reads your text on a dashboard, not in a chat.\n\n"
